...
grails.project.groupId = Forms // change this to alter the default package name and Maven publishing destination
...
environments {
    development {
        ...
        uploadFolder = "/Users/Jur1cek/Desktop/tmp/"
        grails.serverURL = "http://localhost:8080/Forms"
    }
    production {
...
grails.plugin.springsecurity.roleHierarchy = '''
   ...
   ROLE_ADMIN > ROLE_UNIVERSITY
   ROLE_UNIVERSITY > ROLE_SPECIAL
   ROLE_SPECIAL > ROLE_FACULTY
   ROLE_FACULTY > ROLE_WORKER
'''

grails.plugin.springsecurity.acl.authority.
        modifyAuditingDetails = 'ROLE_WORKER'
grails.plugin.springsecurity.acl.authority.
        changeOwnership = 'ROLE_WORKER'
grails.plugin.springsecurity.acl.authority.
        changeAclDetails = 'ROLE_WORKER'

grails.plugin.admin.accessRoot = "/admin"
grails.plugin.admin.security.role = "ROLE_ADMIN"
grails.plugin.admin.domains = [
        "form.Form",
        "form.FormFieldsVersion",
        "form.FormType",
        "user.Role",
        "user.User",
        "user.UserRole",
